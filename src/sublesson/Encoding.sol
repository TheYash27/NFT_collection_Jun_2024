...
contract Encoding {
    function combineStrings() public pure returns (string memory) {
        return string(abi.encodePacked("YA", "SH"));
    }
    ...
    function encodeString() public pure returns (bytes memory) {
        bytes memory someString = abi.encode("I LOVE");
        return someString;
    }
    ...
    function encodeStringPacked() public pure returns (bytes memory) {
        bytes memory someString = abi.encodePacked("I LOVE");
        return someString;
    }
    ...
    function encodeStringBytes() public pure returns (bytes memory) {
        bytes memory someString = bytes("I LOVE");
        return someString;
    }
    ...
    function multiEncode() public pure returns (bytes memory) {
        bytes memory someString = abi.encode("I LOVE", "YASH");
        return someString;
    }
    ...
    function multiEncodePacked() public pure returns (bytes memory) {
        bytes memory someString = abi.encodePacked("I LOVE", "YASH");
        return someString;
    }
