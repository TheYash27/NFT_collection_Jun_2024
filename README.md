...
<br/>
<p align="center">
<img src="./images/HPNFT/HP.jpg" width="225" alt="NFT Harry Potter">
...
Then, you can get the base64 encoding of the json object by placing the imageURI into `happySVGMetadata.json` then running:

```
echo "data:application/json;base64,$(base64 -i ./images/dynamicNFT/happySVGMetadata.json)"
```
